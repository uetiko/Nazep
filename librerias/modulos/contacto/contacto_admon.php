						...
						echo '<form name="frm_configurar_contacto" id="frm_configurar_contacto" method="post"  action="index.php?opc=111&amp;clave_seccion='.$clave_seccion_enviada.'" class="margen_cero" >';
							echo '<table width="100%" border="0" cellspacing="0" cellpadding="0" >';
								echo '<tr><td align ="left">'.con_txt_env_corr.'</td>';
									echo '<td align ="left">';
										echo '<select name = "enviar_correo">';
											echo '<option value = "si" '; if ($enviar_correo == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($enviar_correo == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
								...
								echo '<tr><td align ="left" bgcolor="#F9D07B">'.con_txt_ped_tema.'</td>';
									echo '<td align ="left" bgcolor="#F9D07B">';
										echo '<select name = "pedir_tema">';
											echo '<option value = "si" '; if ($pedir_tema == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($pedir_tema == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';	
								echo '<tr><td align ="left">'.con_txt_ped_nom_com.'</td><td align ="left">';
										echo '<select name = "pedir_nombre_compuesto">';
											echo '<option value = "si" '; if ($pedir_nombre_compuesto == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($pedir_nombre_compuesto == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
								echo '<tr><td align ="left" bgcolor="#F9D07B">'.con_txt_obl_nom_com.'</td><td align ="left" bgcolor="#F9D07B">';
										echo '<select name = "obligar_nombre_compuesto">';
											echo '<option value = "si" '; if ($obligar_nombre_compuesto == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($obligar_nombre_compuesto == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
								echo '<tr><td align ="left">'.con_txt_ped_nom_completo.'</td><td align ="left">';
										echo '<select name = "pedir_nombre_largo">';
											echo '<option value = "si" '; if ($pedir_nombre_largo == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($pedir_nombre_largo == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
								echo '<tr><td align ="left" bgcolor="#F9D07B">'.con_txt_obl_nom_completo.'</td><td align ="left" bgcolor="#F9D07B">';
										echo '<select name = "obligar_nombre_largo">';
											echo '<option value = "si" '; if ($obligar_nombre_largo == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($obligar_nombre_largo == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
								echo '<tr><td align ="left">'.con_txt_ped_corr.'</td><td align ="left">';
										echo '<select name = "pedir_correo">';
											echo '<option value = "si" '; if ($pedir_correo == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($pedir_correo == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
								echo '<tr><td align ="left" bgcolor="#F9D07B">'.con_txt_obl_corr.'</td><td align ="left" bgcolor="#F9D07B">';
										echo '<select name = "obligar_correo">';
											echo '<option value = "si" '; if ($obligar_correo == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($obligar_correo == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';	
								echo '<tr><td align ="left">'.con_txt_ped_sit.'</td><td align ="left">';
										echo '<select name = "pedir_sitio_web">';
											echo '<option value = "si" '; if ($pedir_sitio_web == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($pedir_sitio_web == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
								echo '<tr>';
									echo '<td align ="left" bgcolor="#F9D07B">'.con_txt_obl_sit.'</td><td align ="left" bgcolor="#F9D07B">';
										echo '<select name = "obligar_sitio_web">';
											echo '<option value = "si" '; if ($obligar_sitio_web == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($obligar_sitio_web == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
								echo '<tr><td align ="left">'.con_txt_ped_tel.'</td><td align ="left">';
										echo '<select name = "pedir_telefono">';
											echo '<option value = "si" '; if ($pedir_telefono == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($pedir_telefono == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
								echo '<tr><td align ="left" bgcolor="#F9D07B">'.con_txt_obl_tel.'</td><td align ="left" bgcolor="#F9D07B">';
										echo '<select name = "obligar_telefono">';
											echo '<option value = "si" '; if ($obligar_telefono == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($obligar_telefono == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
								echo '<tr><td align ="left">'.con_txt_ped_fax.'</td><td align ="left">';
										echo '<select name = "pedir_fax">';
											echo '<option value = "si" '; if ($pedir_fax == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($pedir_fax == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
								echo '<tr><td align ="left" bgcolor="#F9D07B">'.con_txt_obl_fax.'</td><td align ="left" bgcolor="#F9D07B">';
										echo '<select name = "obligar_fax">';
											echo '<option value = "si" '; if ($obligar_fax == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($obligar_fax == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
								echo '<tr><td align ="left">'.con_txt_ped_dir.'</td><td align ="left">';
										echo '<select name = "pedir_direccion">';
											echo '<option value = "si" '; if ($pedir_direccion == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($pedir_direccion == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
								echo '<tr><td align ="left" bgcolor="#F9D07B">'.con_txt_obl_dir.'</td><td align ="left" bgcolor="#F9D07B">';
										echo '<select name = "obligar_direccion">';
											echo '<option value = "si" '; if ($obligar_direccion == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($obligar_direccion == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
								echo '<tr><td align ="left">'.con_txt_ped_pais.'</td><td align ="left">';
										echo '<select name = "pedir_pais">';
											echo '<option value = "si" '; if ($pedir_pais == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($pedir_pais == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
								echo '<tr><td align ="left" bgcolor="#F9D07B">'.con_txt_ped_msj.'</td><td align ="left" bgcolor="#F9D07B">';
										echo '<select name = "pedir_mensaje">';
											echo '<option value = "si" '; if ($pedir_mensaje == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($pedir_mensaje == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
								echo '<tr><td align ="left">'.con_txt_obl_msj.'</td><td align ="left">';
										echo '<select name = "obligar_mensaje">';
											echo '<option value = "si" '; if ($obligar_mensaje == "si") { echo 'selected'; } echo '  >'.si.'</option>';
											echo '<option value = "no"  '; if ($obligar_mensaje == "no") { echo 'selected'; } echo ' >'.no.'</option>';
										echo '</select>';
									echo '</td>';
								echo '</tr>';
