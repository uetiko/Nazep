...
Funci�n archivo: archivo para controlar la vista final del m�dulo de recomendar
		...
		function vista_redireccion($sec, $ubicacion_tema, $nick_usuario, $clave_modulo)
			{
				...
				if($paso)
					...
					{
						if($error==1)
							echo 'fallo-No se pudo enviar la Recomendaci�n';
						else
							echo 'fallo-Se envio la Recomendaci�n, pero no se registro';
					}
			}
