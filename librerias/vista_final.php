...
Funci�n archivo: Contener todas las funciones necesarias para ver el portal
...
//************************************************************************ INICIO FUNCIONES PARA MULTIPLES USOS **************************************************************
		...
		function lis_secc_prin_ver_tablas($inicio, $cantidad, $ancho, $mostrar_titulo, $titulo, $mostrar_balazo, $ubicacion_tema, $espacio_secciones, $imagen_balazo, $alt_bal, $titulo_bal)
			{
				/*Funci�n descotinuada, por usar tablas, remplazada por lis_secc_prin_ver_ul en la version 0.1.6*/
				$inicio--;
				$hoy = date('Y-m-d');
		...
		function lis_secc_prin_hor_tablas($inicio, $cantidad, $simbolo, $ancho)
			{
				/*
				Funci�n que te permite hacer un listado de las secciones principales del portal 
